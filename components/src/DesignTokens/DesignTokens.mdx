...
<Typeset fontWeight={500} fontFamily='SWR-VAR-Sans' sampleText='Pollenflug in BW: Was Heuschnupfengeplagte jetzt wissen sollten' fontSizes={Object.entries(typography.sizes).map(([key, size]) => {
	return size
})}/>
