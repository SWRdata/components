...
- **[InspectControl](?path=/docs/maplibre-control-inspectcontrol--docs)**: Renders maplibre's [inspect control](https://maplibre.org/maplibre-gl-inspect/API/index.html)
...
- **[SWR Data Lab Dark](?path=/docs/maplibre-style-swr-data-lab-dark--docs)**: Dark-themed basemap using SWR colours and typefaces
